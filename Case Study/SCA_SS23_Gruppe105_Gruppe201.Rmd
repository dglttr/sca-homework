...
```{r}
mat_verlauf_gruppeB <- mat_verlauf_gruppeB %>% mutate(cum_sum = cumsum(Menge))
...
ts_3d_Scheiben <- ts(prep, frequency = 365.25)
...
```{r}
fcast_3d_Scheiben = forecast(m_3d_Scheiben, 365)
