...
```{r}
sicherheitsbestand$meldebestand <- meldebestand$meldebst
sicherheitsbestand$nachfrage <- tägl_nachfrage$Nachfrage_quantile
sicherheitsbestand$WBZ <- wbz$WBZ_quantile
