...
print(totalcost_105)
```
Die Gesamtkosten setzen sich zusammen aus den Transportkosten von Deutschland nach Asien sowie den Kosten für Logistikdienstleister im Warehousing der Großlager in Asien und den Transport von den Großlagern zu den Supermärkten als Endabnehmer.
...
### 2. Datenbeschaffung
Als nächstes mappen und beschreiben wir existierende Datenquellen. Die Datensätze der Jahre 2018 bis 2022 wurden bereits von den Supermärkten sowie von den Logistikdienstleistern bereitgestellt, sie beinhalten auch Informationen über die Konkurrenz in den fünf Regionen. Basierend auf dieser Übersicht können wir relevante Daten systematisch auswählen oder wo nötig weitere Daten beschaffen.
