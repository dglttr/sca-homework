...
cost$Month <- as.factor(cost$Month)
cost$Year <- as.factor(cost$Year)
```

```{r}
# Filter data outside of 2018-2022
cost18_22 <- cost[cost$Year <= 2022 & cost$Year >= 2018, ]
services18_22 <- services[services$Year <= 2022 & services$Year >= 2018, ]
transactions18_22 <- transactions[transactions$Year <= 2022 & transactions$Year >= 2018, ]
