...
cat("Bei Betrachtung der tatsächlich verkauften Menge (ohne Lost Sales) ergibt sich ein (gerundeter) Marktanteil von", round(marketshare, digits = 3)*100, "%.")
```
...
# Projektbeschreibung
Kurze Einleitung
- Analyseprojekt, das systematisch Mehrwert generieren soll

## Projektdurchführung
Plan für Durchführung/Vorgehensweise (Projektabschnitte)
- CRISP-DM
...
## Datenquellen
- Unternehmensinternes ERP-System, beispielsweise folgende SAP-Module:
  - Sales & Distribution (SD): Für Vertriebsdaten
  - Finance (FI): Für Kosten und Zahlungsverlauf mit Dienstleistern
- Externe Datenbanken:
...
## Nutzer:innen
- High-Level Erkenntnisse für CSCO (Chief Supply Chain Officer) oder ähnlich
- Zeitnahe, relevante Ergebnisse für Angestellte, die mit LDL zusammenarbeiten/ diese beauftragen

## Empfehlungen basierend auf Teil 2.1
- Vorschläge zu Verträgen mit bestimmten LDL
Vorab: Weitere Analysen nötig. Z.B. schauen, ob bestimmte LDL besonders in bestimmten Regionen agieren (z. B. Bange+Hammer Shipping).

- Shipping-Dienstleister:
  - Verträge mit Bange+Hammer priorisieren
- Warehousing-Dienstleister:
  - Kein akuter Handlungszwang
  - Nach Möglichkeit Verträge mit Flying Mercury Warehousing ausweiten
